const RANKS = {
    ...
    desc: {
		...
		oct: {
			...
			'6': "八重阶层2的效果变得更强.",
			'8': "使强化器的溢出弱化.",
			'9': "使加速器的二重软上限延迟至2.5倍出现且弱化.",
			'10': "使八重阶层加成无限质量和永恒质量.",
			'12': "使八重阶层加成七重阶层52的效果.",
			'17': "使六重阶层的的元折算弱化99.6%.",
			'20': "移除六重阶层的超级折算.八重阶层1的效果也能弱化六重阶层的的超究折算和元折算.",
			'21': "使加速器的二重软上限延迟至2倍出现且弱化.",
			'29': "使加速器的二重软上限延迟至2倍出现且弱化.",
			'33': "使加速器的二重软上限弱化.",
			'34': "使八重阶层加成奇异物质获取.",
			'35': "使八重阶层34的效果平方.",
			'46': "使降伏器的的超级折算弱化4%.",
		...
		enne: {
            ...
            '100': "解锁超等级，移除从等级到五重阶层的所有阶层.",
            '101': "使十重阶层加成奇异物质的获取.",
            '102': "使六重阶层的元折算基于九重阶层的数值而延迟.",
            '117': "使六重阶层的元折算延迟至1e50倍出现.",
            '140': "移除五重阶层2效果的软上限.",
            '200': "奇异升级“暗物质推进器”同样影响黑洞质量.",
            '250': "使十重阶层加成暗射线的获取.",
            '300': "使十重阶层加成星尘的获取.",
            '666': "使超新星的元折算弱化99.99%.",
    ...
    rewards: [
        {
            ...
            "135": `使转生等级提升荣耀9的效果.`,
            "140": `使W-玻色子的第一个效果也对质量获取速度的七重软上限生效.`,
		...
		},
		{
			...
			"39": `Prestige Dark Matter effect 的效果变得更强.`,
			"40": `The Entropy Gain effect from Supernova Galaxies 的效果变得更强.`,
		...
		},
		{
            ...
            "73": "Valor 11 effect 的效果变得更强.",
            "74": "Enne 14 effect 的效果变得更强.",
		},
    ],
    rewardEff: [
        {
    ...
    rewards: [
        {
            ...
            "28": `Ascension Mass Formula from Ascension Level 的效果变得更强.`,
            ...
            "65": `Prestige Black Hole Effect 的效果变得更强.`,
			"80": `Ascension Level boost Honor 9 effect.`,
            "87": `Ascension Mass effect 的效果变得更强.`,
        ...
        },
        {
            ...
            "25": `Collapsed Stars Effect 的效果变得更强.`,
            ...
            "50": `Transcension Level 18 effect 的效果变得更强.`,
            ...
            "160": `Dark Run Upgrade 10 的效果变得更强.`,
            "190": `Dark Run Upgrade 10 的效果变得更强.`,
        ...
        },
		{
            ...
            "7": `Transcension Level 16 effect 的效果变得更强.`,
            ...
            "23": `Dark Run Upgrade 13 的效果变得更强.`,
            "24": `Enne 14 的效果变得更强.`,
            "25": `Galactic Particles 的效果变得更强.`,
