const QUANTUM = {
    ...
    mils: [
        ...
        [E(1), `Pre-Quantum Supernova tree will be without the requirement. Pre-Quantum global speed is increased by 10x.`],
        [E(2), `You start with the pre-Quantum tree of Challenges, tree [c, qol7] unlocked.`],
        [E(3), `You start with QoL (qol8-9 & unl1), Radiation unlocked.`],
